document.addEventListener("DOMContentLoaded", () => {
  ...
  const translations = {
    ...
    en: {
      ...
      about_h2: "About Us",
      about_p1:
        "Since 2016, ROCKET PHARM LLC has provided industry-leading expertise in creating, promoting, and selling high-margin products and private labels in the pharmaceutical market.",
      about_p2:
        "We collaborate with major contract manufacturers to offer a turnkey, balanced assortment of private label and high-margin goods to regional pharmacy chains, wholesalers, and distributors.",
      about_p3:
        "Our products are category leaders with proven track records, high markup, and fast turnover. We operate without excessive SKUs, volume commitments, or delayed rebates.",
      why_h2: "Why Choose Us",
      why_item1: "Unique expertise in key parapharmaceutical categories",
      why_item2: "Best market prices and a curated assortment",
      why_item3: "We work with precision, flexibility, and speed",
      why_tagline:
        '"We know everything about Private Label... and then some. Trust the professionals."',
      benefits_h2: "Private Label Benefits",
      benefits_item1: "Earn 150%...200%...300% at a fair retail price",
      benefits_item2:
        "Earn immediately—no waiting for rebates. Now, you are the manufacturer!",
      benefits_item3:
        "Exclusive products and unique differentiation from competitors",
      products_h2: "Products",
      products_p:
        "ROCKET PHARM offers only verified, high-quality products in the most in-demand parapharmaceutical categories:",
      product_item1_h4: "Dietary Supplements & Healthy Nutrition",
      product_item1_li1: "Vitamins, multivitamins, muesli bars, healthy snacks",
      product_item1_li2: "Vitamin-enriched lozenges and chewing gum",
      product_item2_h4: "Medical Supplies",
      product_item2_li1: "Sanitary consumables",
      product_item2_li2: "Dressings, plasters, bandages",
      product_item2_li3: "Patient care",
      product_item3_h4: "Hygiene Products",
      product_item3_li1: "Wet wipes, cotton pads, cotton buds",
      product_item3_li2: "Feminine hygiene",
      product_item4_h4: "Cosmetics",
      product_item4_li1: "Shampoos, masks, creams, gels, soaps",
      product_item4_li2: "Intimate care products",
      product_item4_li3: "Repellents, sun protection",
      product_item5_h4: "Family Planning",
      product_item5_li1: "Condoms, tests, lubricants",
      product_item6_h4: "Baby Products",
      product_item6_li1: "Baby cosmetics, disposable underpads",
      product_item6_li2: "Wet wipes, cotton products",
      products_button: "Get Full Product Catalog",
      contacts_header_h2: "CONTACT US",
      contact_detail_h3: "Rocket Pharm LLC",
      contact_detail_location: "18 Bazhova St., Moscow, 129128",
